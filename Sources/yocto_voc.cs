/*********************************************************************
 *
 * $Id: yocto_voc.cs 12324 2013-08-13 15:10:31Z mvuilleu $
 *
...
public class YVoc : YFunction
{
  ...
  public delegate void UpdateCallback(YVoc func, string value);
  ...
  private static Hashtable _VocCache = new Hashtable();
  ...
  public YVoc(string func)
    : base("Voc", func)
  {
    _logicalName = YVoc.LOGICALNAME_INVALID;
    _advertisedValue = YVoc.ADVERTISEDVALUE_INVALID;
    _unit = YVoc.UNIT_INVALID;
    _currentValue = YVoc.CURRENTVALUE_INVALID;
    _lowestValue = YVoc.LOWESTVALUE_INVALID;
    _highestValue = YVoc.HIGHESTVALUE_INVALID;
    _currentRawValue = YVoc.CURRENTRAWVALUE_INVALID;
    _calibrationParam = YVoc.CALIBRATIONPARAM_INVALID;
    _resolution = YVoc.RESOLUTION_INVALID;
   ...
   * </returns>
   * <para>
   *   On failure, throws an exception or returns <c>YVoc.LOGICALNAME_INVALID</c>.
   * </para>
   */
   ...
   * </returns>
   * <para>
   *   On failure, throws an exception or returns <c>YVoc.ADVERTISEDVALUE_INVALID</c>.
   * </para>
   */
   ...
   * </returns>
   * <para>
   *   On failure, throws an exception or returns <c>YVoc.UNIT_INVALID</c>.
   * </para>
   */
  public string get_unit()
  {
    if (_unit == YVoc.UNIT_INVALID)
    {
      if (YAPI.YISERR(load(YAPI.DefaultCacheValidity)))
   ...
   * </returns>
   * <para>
   *   On failure, throws an exception or returns <c>YVoc.CURRENTVALUE_INVALID</c>.
   * </para>
   */
   ...
   * </returns>
   * <para>
   *   On failure, throws an exception or returns <c>YVoc.LOWESTVALUE_INVALID</c>.
   * </para>
   */
   ...
   * </returns>
   * <para>
   *   On failure, throws an exception or returns <c>YVoc.HIGHESTVALUE_INVALID</c>.
   * </para>
   */
   ...
   * </returns>
   * <para>
   *   On failure, throws an exception or returns <c>YVoc.CURRENTRAWVALUE_INVALID</c>.
   * </para>
   */
   ...
   * </returns>
   * <para>
   *   On failure, throws an exception or returns <c>YVoc.RESOLUTION_INVALID</c>.
   * </para>
   */
  ...
  private static void _VocCleanup()
  { }
