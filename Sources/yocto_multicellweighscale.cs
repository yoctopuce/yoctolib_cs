/*********************************************************************
 *
 * $Id: yocto_multicellweighscale.cs 29661 2018-01-18 13:32:13Z mvuilleu $
 *
...
//--- (end of YMultiCellWeighScale class start)
     ...
     * </para>
     */
    public int set_compTempAdaptRatio(double newval)
    {
        string rest_val;
        lock (_thisLock) {
     ...
     * </para>
     */
    public double get_compTempAdaptRatio()
    {
        double res;
        lock (_thisLock) {
            if (this._cacheExpiration <= YAPI.GetTickCount()) {
