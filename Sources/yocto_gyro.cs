/*********************************************************************
 *
 * $Id: yocto_gyro.cs 67413 2025-06-12 09:12:41Z seb $
 *
...
//--- (end of generated code: YGyro class start)
    ...
    public virtual int _loadQuaternion()
    {
        int now_stamp;
        int age_ms;
        now_stamp = unchecked((int) (YAPI.GetTickCount() & 0x7FFFFFFF));
    ...
    public virtual int _invokeGyroCallbacks(int qtIndex, double qtValue)
    {
        ...
        this._qt_stamp = unchecked((int) (YAPI.GetTickCount() & 0x7FFFFFFF));
        if (this._quatCallback != null) {
