...
//--- (YSoundLevel dlldef_core)
//--- (end of YSoundLevel dlldef_core)
//--- (YSoundLevel dll_core_map)
//--- (end of YSoundLevel dll_core_map)
//--- (YSoundLevel dlldef)
...
//--- (end of YSoundLevel class start)
    ...
    public new delegate void ValueCallback(YSoundLevel func, string value);
    public new delegate void TimedReportCallback(YSoundLevel func, YMeasure measure);
    ...
    public YSoundLevel(string func)
        : base(func)
    {
    ...
    public override int _invokeValueCallback(string value)
    {
        if (this._valueCallbackSoundLevel != null) {
            this._valueCallbackSoundLevel(this, value);
        } else {
    ...
    public override int _invokeTimedReportCallback(YMeasure value)
    {
        if (this._timedReportCallbackSoundLevel != null) {
            this._timedReportCallbackSoundLevel(this, value);
        } else {
    ...
    public static YSoundLevel FirstSoundLevel()
    {
        ...
        err = YAPI.apiGetFunctionsByClass("SoundLevel", 0, p, size, ref neededsize, ref errmsg);
        ...
        if ((YAPI.YISERR(YAPI.yapiGetFunctionInfo(v_fundescr[0], ref dev, ref serial, ref funcId, ref funcName, ref funcVal, ref errmsg))))
            return null;
        return FindSoundLevel(serial + "." + funcId);
    }
