...
//--- (YAngularSpeed dlldef_core)
//--- (end of YAngularSpeed dlldef_core)
//--- (YAngularSpeed dll_core_map)
//--- (end of YAngularSpeed dll_core_map)
...
//--- (end of YAngularSpeed class start)
    ...
    public new delegate void ValueCallback(YAngularSpeed func, string value);
    public new delegate void TimedReportCallback(YAngularSpeed func, YMeasure measure);
    ...
    public YAngularSpeed(string func)
        : base(func)
    {
    ...
    public override int _invokeValueCallback(string value)
    {
        if (this._valueCallbackAngularSpeed != null) {
            this._valueCallbackAngularSpeed(this, value);
        } else {
    ...
    public override int _invokeTimedReportCallback(YMeasure value)
    {
        if (this._timedReportCallbackAngularSpeed != null) {
            this._timedReportCallbackAngularSpeed(this, value);
        } else {
    ...
    public static YAngularSpeed FirstAngularSpeed()
    {
        ...
        err = YAPI.apiGetFunctionsByClass("AngularSpeed", 0, p, size, ref neededsize, ref errmsg);
        ...
        if ((YAPI.YISERR(YAPI.yapiGetFunctionInfo(v_fundescr[0], ref dev, ref serial, ref funcId, ref funcName, ref funcVal, ref errmsg))))
            return null;
        return FindAngularSpeed(serial + "." + funcId);
    }
